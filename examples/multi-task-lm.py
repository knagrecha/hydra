...
def main():
    ...
    # Presumably this does not fit on one device. Adjust batch size or
    # architecture as needed.
    model_0 = torch.nn.Sequential(

        # OPENER
        custom.BertEmbedding(28783, 768),
        ...
        custom.BertTransformerEncoderLayer(768, 16, 1024, 0.5),
        custom.BertTransformerEncoderLayer(768, 16, 1024, 0.5),
        custom.BertTransformerEncoderLayerEnd(768, 768),
        torch.nn.Tanh(),
    ...
    """"
        Multi-task generation. Note that in this case, the tasks are identical,
