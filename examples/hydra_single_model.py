...
def main(seed):
    ...
    learning_rates = [3e-4]
    batch_sizes = [16]
    prt = Presharded([4, 8, 12, 16, 20, 24, 28, 32, 36, 40, 44, 48, 51])
    ...
    for idx, lr in enumerate(learning_rates):
        for b_size in batch_sizes:
            ...
            task = ModelTask("MODEL_{}_{}".format(lr_names[idx], b_size), new_model, pretraining_loss, dataloader, lr, 1, partitioner=prt)
