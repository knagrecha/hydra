...
class Model():
    def __init__(self, model):
        ...
        print("{} Layers to Shard".format(len(self.layers) ))
    def setup(self, true_criterion, batch_orig, buffer, lr):
        ...
        sequence_outs = []
        split_indices = []
        print("======================Partitioning for {} layers======================".format(len(self.layers)))
        while true_layer_index < (len(self.layers)):
            ...
            try:
                ...
                print("| Splits: {} | Layer Index: {} | Memory {} |".format(split_indices, true_layer_index, [get_free_space(x) for x in available_devices]))
            ...
            if (oom):
                ...
                #print("Problem Layer: {}".format(pioneer_layer))
                ...
                print("Free Memory: {}".format([get_free_space(x) for x in available_devices]))
